...
ST0 = slTuner('DOF3_RRR_PID_Step',TunedBlocks);
...
RefSignals = {...
   'DOF3_RRR_PID_Step/Signal Builder/q1', 'DOF3_RRR_PID_Step/Signal Builder/q2', 'DOF3_RRR_PID_Step/Signal Builder/q3'};
addPoint(ST0,RefSignals)

%% Defining Input and Outputs and Tuning the system
Controls = TunedBlocks;      % actuator commands
Measurements = 'DOF3_RRR_PID_Step/Robot/qm';  % joint angle measurements
