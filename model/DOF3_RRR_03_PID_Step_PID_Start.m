...
ST0 = slTuner('DOF3_RRR_03_PID_Step_PID',TunedBlocks);
...
RefSignals = {...
   'DOF3_RRR_03_PID_Step_PID/Signal Builder/q1', 'DOF3_RRR_03_PID_Step_PID/Signal Builder/q2', 'DOF3_RRR_03_PID_Step_PID/Signal Builder/q3'};
addPoint(ST0,RefSignals)

%% Defining Input and Outputs and Tuning the system
Controls = TunedBlocks;      % actuator commands
Measurements = 'DOF3_RRR_03_PID_Step_PID/Robot/qm';  % joint angle measurements
...
%  sim('DOF3_RRR_03_PID_Step_PID.slx',3)